...
def get_user_text(message):
    ...
    if message.text == "✅":
        ...
        photo = open(r"C:\Users\imand\OneDrive\Изображения\TAQYRYP.png", 'rb')
    ...
    if message.text == "/komek":
        ...
        photo = open(r"C:\Users\imand\OneDrive\Изображения\Снимок экрана (14).png", 'rb')
        bot.send_photo(message.chat.id, photo=photo)
    ...
    if message.text == "/formula":
        ...
        photo = open(r"C:\Users\imand\OneDrive\Изображения\formula.png", 'rb')
        bot.send_photo(message.chat.id, photo=photo)

    if message.text == "1️⃣":
        video = open(r"C:\Users\imand\Videos\Captures\1 taqyryp .mp4", 'rb')
        bot.send_video(message.chat.id, video=video)
    if message.text == "2️⃣":
        video = open(r"C:\Users\imand\Videos\Captures\2 taqyryp.mp4", 'rb')
        bot.send_video(message.chat.id, video=video)
    if message.text == "3️⃣":
        video = open(r"C:\Users\imand\Videos\Captures\3 takyryp.mp4", 'rb')
        bot.send_video(message.chat.id, video=video)
    if message.text == "4️⃣":
        video = open(r"C:\Users\imand\Videos\Captures\4 taqyryp.mp4", 'rb')
        bot.send_video(message.chat.id, video=video)
    ...
    if message.text == "1.2":
        photo = open(r"C:\Users\imand\OneDrive\Изображения\1.2.png", 'rb')
        bot.send_photo(message.chat.id, photo=photo)
    ...
    def callback(call, message=None):
        if call.data == "button1":
            photo = open(r"C:\Users\imand\OneDrive\Изображения\1.1.png", 'rb')
        ...
        if call.data == "button11":
            photo = open(r"C:\Users\imand\OneDrive\Изображения\Снимок экрана (11).png", 'rb')
            bot.send_photo(call.message.chat.id, photo=photo)
            bot.send_message(call.message.chat.id, 'Жауабын көріп белгілегіңіз келсе Жауабы2.1 деп жазыңыз')
        if call.data == "button12":
            photo = open(r"C:\Users\imand\OneDrive\Изображения\Снимок экрана (15).png", 'rb')
            bot.send_photo(message.chat.id, photo=photo)
        ...
        if call.data == "button21":
            photo = open(r"C:\Users\imand\OneDrive\Изображения\Снимок экрана (16).png", 'rb')
            bot.send_photo(message.chat.id, photo=photo)
            bot.send_message(call.message.chat.id, 'Жауабын көріп белгілегіңіз келсе Жауабы3.1 деп жазыңыз')
        if call.data == "button22":
            photo = open(r"C:\Users\imand\OneDrive\Изображения\Снимок экрана (17).png", 'rb')
            bot.send_photo(message.chat.id, photo=photo)
        ...
        if call.data == "button31":
            photo = open(r"C:\Users\imand\OneDrive\Изображения\Снимок экрана (18).png", 'rb')
            bot.send_photo(message.chat.id, photo=photo)
            bot.send_message(call.message.chat.id, 'Жауабын көріп белгілегіңіз келсе Жауабы4.1 деп жазыңыз')
        if call.data == "button32":
            photo = open(r"C:\Users\imand\OneDrive\Изображения\Снимок экрана (19).png", 'rb')
            bot.send_photo(message.chat.id, photo=photo)
